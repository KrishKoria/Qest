  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div
            className={`rounded-lg px-4 py-2 max-w-none ${
              isUser
  ...
  const quickActions = [
    {
      ...
      message:
        "Can you create a beginner-friendly workout plan for strength training?",
    },
    {
    ...
    },
    {
      ...
      message:
        "How can I modify a workout program for someone with knee issues?",
    },
  ];
              ...
              {messages.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full text-center">
                  ...
                  <p className="text-gray-600 mb-4">
                    Ask your AI agent for fitness advice, workout plans, or
                    nutrition guidance.
                  </p>
                  <p className="text-sm text-gray-500">
                    Try: "Create a beginner workout plan" or use the quick
                    actions on the left.
                  </p>
                </div>
              ) : (
