...
export const api = {
  ...
  agents: {
    ...
    getAvailableAgents: () => 
      apiClient.get('/agents/available'),
  ...
  members: {
    ...
    update: (id, memberData) => 
      apiClient.put(`/members/${id}`, memberData),
  ...
  classes: {
    ...
    getUpcoming: () => 
      apiClient.get('/classes/upcoming'),
  ...
  instructors: {
    ...
    create: (instructorData) => 
      apiClient.post('/instructors', instructorData),
  ...
  memberships: {
    ...
    getById: (id) => 
      apiClient.get(`/memberships/${id}`),
    
    create: (membershipData) => 
      apiClient.post('/memberships', membershipData),
    ...
    getActive: () => 
      apiClient.get('/memberships/active'),
  ...
  external: {
    getWeather: () => 
      apiClient.get('/external/weather'),
...
export const handleApiError = (error) => {
  if (error.response) {
    ...
    switch (status) {
      ...
      case 422:
        return { message: data.detail || 'Validation error', type: 'validation', errors: data.errors };
      case 429:
